...
export default async function MoviePage({params}) {
  ...
  return (
    <div>
        ...
        <div className="md:pt-8 flex flex-col md:flex-row items-start content-center mx-auto max-w-6xl md:space-x-6">
        ...
        <div className='flex flex-col gap-3'>
            <h2 className='font-medium'>{movie.title || movie.name}</h2>
            <p>{movie.overview}</p>
        </div>
